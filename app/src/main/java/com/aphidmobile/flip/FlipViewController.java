...
public class FlipViewController extends AdapterView<Adapter> {
  ...
  private Bitmap.Config animationBitmapFormat = Bitmap.Config.ARGB_8888;
    ...
    private OnOverFlipListener onOverFlipListener;
  ...
  public FlipViewController(Context context, AttributeSet attrs, int defStyle) {
    ...
    try {
      int value = a.getInteger(R.styleable.FlipViewController_fvc_orientation, VERTICAL);
      if (value == HORIZONTAL) {
  ...
  private class MyDataSetObserver extends DataSetObserver {
    ...
    public void setOnOverFlipListener(OnOverFlipListener onOverFlipListener) {
        this.onOverFlipListener = onOverFlipListener;
    }

    public OnOverFlipListener getOnOverFlipListener() {
        return  this.onOverFlipListener;
    }
}