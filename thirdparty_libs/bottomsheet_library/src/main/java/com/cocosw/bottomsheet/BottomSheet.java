...
public class BottomSheet extends Dialog implements DialogInterface {
        ...
        adapter = new RecyclerView.Adapter() {
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
                ...
                if (holder.getItemViewType() == TYPE_MENUITEM) {
                    ...
                    if(builder.applyColorFilter)
                        viewHolder.title.setTextColor(builder.colorFilter);
                    if (item.icon == null)
                        viewHolder.image.setVisibility(View.GONE);
                    else {
                        viewHolder.image.setVisibility(View.VISIBLE);
                        if(builder.applyColorFilter) {
                            item.icon.setColorFilter(builder.colorFilter, PorterDuff.Mode.SRC_IN);
                        }
    ...
    public static class Builder {
        ...
        private boolean applyColorFilter = false;
        ...
        public Builder applyColorFilter(int colorFilter) {
