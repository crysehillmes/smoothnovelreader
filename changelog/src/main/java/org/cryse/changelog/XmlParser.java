...
public class XmlParser extends BaseParser {
    ...
    private int mBugFixPrefixResId = 0;
    private int mImprovementPrefixResId = 0;
    ...
    public void setBugFixPrefixResId(@StringRes int resId) {
        this.mBugFixPrefixResId = resId;
    }

    public void setImprovementFixPrefixResId(@StringRes int resId) {
        this.mImprovementPrefixResId = resId;
    }
}