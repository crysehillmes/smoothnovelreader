...
public class ChangeLogRow {
    ...
    /**
     * The resource id of bug prefix.
     */
    private int bugFixPrefixStringResId = 0;

    /**
     * The resource id of improvement.
     */
    private int improvementPrefixStringResId = 0;
    ...
    public String getChangeText(Context context) {
        ...
        switch (type) {
            case BUGFIX:
                if(bugFixPrefixStringResId != 0) {
                    prefix = context.getResources().getString(bugFixPrefixStringResId);
    ...
    public void setBugFixPrefixStringResId(int bugFixPrefixStringResId) {
        this.bugFixPrefixStringResId = bugFixPrefixStringResId;
    }

    public void setImprovementPrefixStringResId(int improvementPrefixStringResId) {
        this.improvementPrefixStringResId = improvementPrefixStringResId;
    }
}