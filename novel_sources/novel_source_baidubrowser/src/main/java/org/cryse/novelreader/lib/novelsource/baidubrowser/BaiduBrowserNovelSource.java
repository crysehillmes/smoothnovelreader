...
public class BaiduBrowserNovelSource implements NovelSource {
    public static final int SOURCE_BAIDU_BROWSER = Consts.SOURCE_BAIDU_BROWSER;
    public static final String SOURCE_NAME_BAIDU_BROWSER = Consts.SOURCE_NAME_BAIDU_BROWSER;
    private static final String LOG_TAG = BaiduBrowserNovelSource.class.getSimpleName();
    /*private OkHttpClient mOkHttpClient;*/
    private BaiduBrowserService mNovelSource;
    ...
    public static NovelSource build(OkHttpClient okHttpClient) {
        return new BaiduBrowserNovelSource(okHttpClient);
    }

    @Override
    public int getNovelType() {
        return SOURCE_BAIDU_BROWSER;
    }

    @Override
    public String getNovelSourceName() {
        return SOURCE_NAME_BAIDU_BROWSER;
    }
